<?php
    ...
    define('SERVIDOR',"http://localhost/SUITS/loginPHPyMYSQL-2332022/");//definir el servidor que estas usando, podeis poner ip para que otro dispositivo conecte y de tu carpeta
